...
function(req, res) { 
  ...
  res.render('index', { title: 'MongoDB Grill', list: req.list, meats: meats, drinks: drinks, mvMeats:req.mvMeats, mvDrinks: req.mvDrinks});
});
